    ...
    <div className="page page-settings">
      ...
      <div className="settings-layout">
        ...
        <aside className="settings-side">
          <article className="privacy-card"><span className="privacy-icon"><Icon name="shield" /></span><p className="eyebrow">Privacy boundary</p><h2>What stays local?</h2><ul><li><Icon name="check" /> Original manual files</li><li><Icon name="check" /> SQLite document records</li><li><Icon name="check" /> Stored embedding vectors</li><li><Icon name="check" /> Conversation history</li></ul><p className="privacy-note">When providers are enabled, rendered pages for visual analysis, selected chunk text and questions are sent to OpenAI. Saved conversation history remains in the local data volume and is not automatically reused as model context. API keys remain in the server environment.</p></article>
